             ...
             <div className="row">
                 <div className="col-md-8 blog-main">
                     ...
                     <div className="blog-post">
                         ...
                         <blockquote>
                             <p>Curabitur blandit tempus porttitor. <strong>Nullam quis risus eget urna
                                 mollis</strong> ornare vel eu leo. Nullam id dolor id nibh ultricies vehicula ut id elit.
                             </p>
                         </blockquote>
                     ...
                     <nav className="blog-pagination">
                         ...
                         <a className="btn btn-outline-secondary disabled" href="/#"  aria-disabled="true">Newer</a>
                     </nav>
                 ...
                 <aside className="col-md-4 blog-sidebar">
                     <div className="p-4 mb-3 bg-light rounded">
                         ...
                         <p className="mb-0">Etiam porta <em>sem malesuada magna</em> mollis euismod. Cras mattis consectetur
